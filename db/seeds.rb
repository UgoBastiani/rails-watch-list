...
list2 = List.create(name: "Ma Deuxième Liste")
p "successful"

Bookmark.destroy_all

Bookmark.create(comment: "oui je suis le test", list: list1, movie: movie1)
Bookmark.create(comment: "vérification de le fonctionnalité", list: list1, movie: movie2)
Bookmark.create(comment: "vérification de le fonctionnalité 2", list: list2, movie: movie4)
Bookmark.create(comment: "vérification de le fonctionnalité 3", list: list1, movie: movie3)
